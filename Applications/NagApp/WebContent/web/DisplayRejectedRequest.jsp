...
<div id="mainDiv">
	...
	<div id="innerMainDiv">	
		<div id="contentDiv">
			...
			<div id="displayRejectedRequest" class="pageContent">			
						...
						<c:when test="${not empty rejectedRequestMap}">
							...
							<thead>
								...
								<tbody>
									...
									<c:forEach items="${rejectedRequestMap}" var="rejectedRequest" varStatus="status">
									<tr>
										...
										<td class="dataTd">
										<fmt:formatDate value="${rejectedRequest.value.createdDate}" type="date" pattern="dd-MM-yyyy" />
										</td>
